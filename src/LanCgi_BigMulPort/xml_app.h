...
xmlChar *xmlGetTextByAttributeName(xmlNode *node,xmlChar *name);//������ͬ������
...
//      删除名字为name的子节点
*/
xmlNode *xmlDelete(xmlNode *parent,char**name,int len);
xmlChar *xmlGetChildText(xmlNode *node,xmlChar *name);
